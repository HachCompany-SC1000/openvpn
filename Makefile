...
target_triplet = sh-unknown-none
...
DIST_COMMON = README $(am__configure_deps) $(dist_noinst_SCRIPTS) \
	...
	$(srcdir)/openvpn.spec.in $(top_srcdir)/configure \
	$(top_srcdir)/install-win32/openvpn.nsi.in AUTHORS COPYING \
...
am_openvpn_OBJECTS = base64.$(OBJEXT) buffer.$(OBJEXT) \
	crypto.$(OBJEXT) error.$(OBJEXT) event.$(OBJEXT) \
	fdmisc.$(OBJEXT) forward.$(OBJEXT) fragment.$(OBJEXT) \
	gremlin.$(OBJEXT) helper.$(OBJEXT) init.$(OBJEXT) \
	...
	packet_id.$(OBJEXT) perf.$(OBJEXT) ping.$(OBJEXT) \
...
openvpn_LDADD = $(LDADD)
openvpn_DEPENDENCIES =  memcmp$U.o
...
ACLOCAL = ${SHELL} /mnt/newdata/home/jochen/emtrion/sc1000/pkgs/src/openvpn/missing --run aclocal-1.8
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} /mnt/newdata/home/jochen/emtrion/sc1000/pkgs/src/openvpn/missing --run tar
AUTOCONF = ${SHELL} /mnt/newdata/home/jochen/emtrion/sc1000/pkgs/src/openvpn/missing --run autoconf
AUTOHEADER = ${SHELL} /mnt/newdata/home/jochen/emtrion/sc1000/pkgs/src/openvpn/missing --run autoheader
AUTOMAKE = ${SHELL} /mnt/newdata/home/jochen/emtrion/sc1000/pkgs/src/openvpn/missing --run automake-1.8
AWK = gawk
CC = sh3-linux-gcc
CCDEPMODE = depmode=gcc3
CFLAGS = -g -O2
CPP = sh3-linux-gcc -E
CPPFLAGS =  -I./../openssl/include/ -I./../lzo/include/ -I.
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
ECHO_C = 
...
IPROUTE = /bin/ip
LDFLAGS =  -L./../openssl/ -L./../lzo/src/.libs/
LIBOBJS =  memcmp$U.o
LIBS = -lssl -lcrypto -llzo2 -ldl 
LTLIBOBJS =  memcmp$U.lo
MAKEINFO = ${SHELL} /mnt/newdata/home/jochen/emtrion/sc1000/pkgs/src/openvpn/missing --run makeinfo
OBJEXT = o
PACKAGE = openvpn
PACKAGE_BUGREPORT = openvpn-users@lists.sourceforge.net
PACKAGE_NAME = OpenVPN
PACKAGE_STRING = OpenVPN 2.0.9
...
infodir = ${prefix}/info
install_sh = /mnt/newdata/home/jochen/emtrion/sc1000/pkgs/src/openvpn/install-sh
...
prefix = /usr/local
program_transform_name = s,^,sh-,
sbindir = ${exec_prefix}/sbin
sharedstatedir = ${prefix}/com
sysconfdir = ${prefix}/etc
target = sh-unknown-none
target_alias = sh
target_cpu = sh
target_os = none
